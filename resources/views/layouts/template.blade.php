  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section id="aboutUs">
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-center mb-6 mb-md-0 order-0 order-md-1"><img class="w-100" src="{{asset('assets/img/gallery/about-us.png')}}" alt="..." /></div>
      ...
      <section>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-center mb-6 mb-md-0"><img class="w-100" src="{{asset('assets/img/gallery/how-to-apply.png')}}" alt="..." /></div>
      ...
      <section class="bg-primary-gradient" id="faq">
        <div class="bg-holder" style="background-image:url({{asset('assets/img/gallery/faq-bg.png')}});background-position:right;background-size:contain;">
        </div>
        <!--/.bg-holder-->
