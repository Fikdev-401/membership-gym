...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('../assetsdashboard/img/apple-icon.png') }}">
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('../assetsdashboard/css/soft-ui-dashboard.css?v=1.1.0') }}" rel="stylesheet" />
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                ...
                <span class="ms-1 font-weight-bold">Alphagym Dashboard</span>
            </a>
        </div>
                    ...
                    <ul class="navbar-nav  justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a class="btn btn-outline-primary btn-sm mb-0 me-3" target="_blank"
                                href="https://www.creative-tim.com/builder?ref=navbar-soft-ui-dashboard">{{Auth::user()->name}}</a>
                        </li>
                        <li class="nav-item d-flex align-items-center">
                                ...
                                <div class="card-body p-3 position-relative">
                                    <div class="row">
                                        <div class="col-8 text-start">
                                            ...
                                            <span class="text-white text-sm">Membership</span>
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <tbody>
                                        @foreach ($dataMember as $member)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $member->paket }}</td>
                                                <td class="text-center">
                                                    <span
                                                        class="text-xs font-weight-bold {{ $member->status === 'Active' ? 'text-success' : 'text-danger' }}">
                                                        {{ $member->status }}
                                                    </span>
                                                </td>
                                                <td class="text-center">
                                                    @if ($member->status === 'Inactive')
                                                        <form action="{{ route('update.status', $member->id) }}"
                                                    ...
                                                    @else
                                                        <span class="text-muted">Already Active</span>
                                                    @endif
                                                </td>
                                                @if (session('success'))
                                                ...
                                                @endif
                                                <td class="text-center">
                                                    <form action="{{ route('delete.user', $member->id) }}" method="POST" style="display:inline-block;">
                                                        @csrf
                                                        @method('DELETE')
